  ...
  public Object nullSafeGet(ResultSet rs, String[] names, Object owner) throws HibernateException, SQLException {
    ...
    if (fqcn == null) {
      ...
      try {
        ...
        throw new HibernateException("Could not load type " + fqcn + " or could not create instance of that type", aErr
            .getCause());
      } catch (InvocationTargetException exc) {
        throw new HibernateException(
            "Creation of identifier of type " + fqcn + " failed with an application exception", exc);
      }
    }
    return result;
  }
