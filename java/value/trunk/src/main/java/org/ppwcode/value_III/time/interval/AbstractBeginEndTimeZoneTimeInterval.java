 ...
 * @mudo unit test
 */
@Copyright("2008 - $Date: 2008-11-04 23:11:14 +0100 (Tue, 04 Nov 2008) $, PeopleWare n.v.")
@License(APACHE_V2)
@SvnInfo(revision = "$Revision: 3421 $",
         date     = "$Date: 2008-11-04 23:11:14 +0100 (Tue, 04 Nov 2008) $")
