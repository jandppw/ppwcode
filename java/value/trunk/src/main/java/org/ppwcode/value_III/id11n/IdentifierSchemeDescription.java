...
/**
 * Annotation for a concrete {@link Identifier} class that contains a URL that refers to a formal
 * description of the implemented identifier scheme.
 *
 * @author    Jan Dockx
...
public @interface IdentifierSchemeDescription {

  /**
   * At this URL a formal description of the annotated identifier scheme can be found.
   */
  String value();
