dojo.provide("ppwcode.dojo.dijit.form._DataViewBox");
...
dojo.declare(
	"ppwcode.dojo.dijit.form._DataViewBox",
	[dijit.layout._LayoutWidget, dijit._Templated],
	{
		...
		_setData: function(newdata) {
			...
			this._dataStore = new ppwcode.dojo.dojo.data.ObjectArrayStore(storeParams);
		...
		clear: function() {
			...
			this._data.items = [];
			this._dataStore = new ppwcode.dojo.dojo.data.ObjectArrayStore({data: []});
			this._masterGrid.setStore(this._dataStore);
