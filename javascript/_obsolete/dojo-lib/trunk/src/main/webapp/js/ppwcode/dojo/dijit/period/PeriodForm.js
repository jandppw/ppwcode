dojo.provide("ppwcode.dojo.dijit.period.PeriodForm");
...
dojo.requireLocalization("ppwcode.dojo.dijit.period", "PeriodForm");

dojo.declare(
  "ppwcode.dojo.dijit.period.PeriodForm",
  [dijit._Widget, dijit._Templated],
  {
    ...
    //
    templatePath: dojo.moduleUrl("ppwcode", "dojo/dijit/period/templates/PeriodForm.html"),
    ...
    constructor: function() {
	  var localizationbundle = dojo.i18n.getLocalization("ppwcode.dojo.dijit.period", "PeriodForm");
