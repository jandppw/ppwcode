dojo.provide("org.ppwcode.dojo.dijit.form.PpwMasterViewWithDelete");
...
dojo.requireLocalization("org.ppwcode.dojo.dijit.form", "PpwMasterViewWithDelete");

dojo.declare(
	"org.ppwcode.dojo.dijit.form.PpwMasterViewWithDelete", 
	[dijit.layout._LayoutWidget, dijit._Templated],
	{
		...
		//
		templatePath: dojo.moduleUrl("org", "ppwcode/dojo/dijit/form/templates/PpwMasterViewWithDelete.html"),
		...
		buildRendering: function() {
			...
			if (this.showButtons !== false) {
				...
				this._addButton.setLabel(dojo.i18n.getLocalization("org.ppwcode.dojo.dijit.form","PpwMasterViewWithDelete").addButtonLabel);
				this._deleteButton.setLabel(dojo.i18n.getLocalization("org.ppwcode.dojo.dijit.form","PpwMasterViewWithDelete").deleteButtonLabel);
			}
			if (this.gridModel) {
