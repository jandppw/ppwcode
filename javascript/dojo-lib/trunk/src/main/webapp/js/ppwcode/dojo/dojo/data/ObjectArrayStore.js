dojo.provide("ppwcode.dojo.dojo.data.ObjectArrayStore");

dojo.require("dojo.data.util.simpleFetch");

dojo.declare(
	"ppwcode.dojo.dojo.data.ObjectArrayStore",
	null,
	{
...
dojo.extend(ppwcode.dojo.dojo.data.ObjectArrayStore,dojo.data.util.simpleFetch);
