dojo.provide("ppwcode.dojo.dijit.form.SearchTextBox");

dojo.require("dijit.form.TextBox");

dojo.declare(
	"ppwcode.dojo.dijit.form.SearchTextBox",
	dijit.form.TextBox,
	{
		//summary:
		...
		templatePath: dojo.moduleUrl("ppwcode", "dojo/dijit/form/templates/SearchTextBox.html"),
