dojo.provide("ppwcode.dojo.dijit.form.ViewFormContainerControllerDwr");
...
dojo.declare(
	"ppwcode.dojo.dijit.form.ViewFormContainerControllerDwr",
	[dijit._Widget, ppwcode.dojo.dijit.form._ViewFormCrudScenariosDwr],
	{
		//summary:
		...
		_createControlledFormsMap: function(formslist) {
			...
			for (var i = 0; i < formslist.length; i++) {
				var ctorname = ppwcode.dojo.util.JavaScriptHelpers.getConstructorFunctionName(formslist[i].constructorFunction);
		...
		setViewIsChild: function(viewviewcontroller) {
			...
			this._disconnectEventHandlers();
			dojo.mixin(this, ppwcode.dojo.dijit.form.ViewFormContainerControllerDwr.ChildController);
			this._connectEventHandlers();
		...
		_displaySelectedItemInFormContainer: function() {
			...
			var theform = this._container.getFormForConstructor(ppwcode.dojo.util.JavaScriptHelpers.getConstructorFunctionName(item.constructor));
...
ppwcode.dojo.dijit.form.ViewFormContainerControllerDwr.ChildController = {
