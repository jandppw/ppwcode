dojo.provide("ppwcode.dojo.dojo.data.EjbRetrieveAllDataStore");
...
dojo.declare("ppwcode.dojo.dojo.data.EjbRetrieveAllDataStore", null, {
  ...
  _assertIsItem: function(/* item */ item) {
    ...
    if (!this.isItem(item)) {
      throw new Error("ppwcode.dojo.data.EjbRetrieveAllDataStore: a function was passed an item argument that was not an item");
    }
  },
  ...
  _assertIsAttribute: function(/* item || String */ attribute) {
    ...
    if (!dojo.isString(attribute)) {
      throw new Error("ppwcode.dojo.data.EjbRetrieveAllDataStore: a function was passed an attribute argument that was not an attribute object nor an attribute name string");
    }
  },
...
dojo.extend(ppwcode.dojo.data.EjbRetrieveAllDataStore, dojo.data.util.simpleFetch);