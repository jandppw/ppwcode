...
dojo.declare(
    ...
    supportedOperation: function(/*String*/ operation){
      ...
      if (!this.supportedOperation("U")) {
        this._viewModeButtonPanel.style.visibility = 'hidden';
      }
      ...
      if (!this.supportedOperation("C")) {
        this._createModeButtonPanel.style.visibility = 'hidden';
      }
      ...
      if (!this.supportedOperation("U")) {
        this._updateModeButtonPanel.style.visibility = 'hidden';
      }
