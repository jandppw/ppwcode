...
dojo.declare("ppwcode.dojo.dijit.form.CrudForm", ppwcode.dojo.dijit.form.ObjectForm, {
  // summary:
  ...
  constructor : function() {
    ...
    this._viewModeEditButton = new dijit.form.Button( {
    ...
    this._createModeSaveButton = new dijit.form.Button( {
    ...
    tempButton = dojo.doc.createElement('button');
    this._createModeButtonPanel.appendChild(tempButton);
    this._createModeCancelButton = new dijit.form.Button( {
    ...
    this._updateModeSaveButton = new dijit.form.Button( {
    ...
    tempButton = dojo.doc.createElement('button');
    this._updateModeButtonPanel.appendChild(tempButton);
    this._updateModeCancelButton = new dijit.form.Button( {
      label : this._localizationbundle.cancelButtonLabel
    }, tempButton);
  ...
  postMixInProperties : function() {
    ...
    if (this.withDelete === true) {
      var tempButton = dojo.doc.createElement('button');
      this._viewModeButtonPanel.appendChild(tempButton);
      this._viewModeDeleteButton = new dijit.form.Button( {
  ...
  _displayPropertyErrorMessage : function(property, errormessage) {
    ...
    tt.__PpwConnectHandle.push(dojo.connect(formwidget, "onChange", null, dojo.hitch(this, this._hideErrorMessage,
        property)));
    ...
    if (formwidget._onKeyPress && dojo.isFunction(formwidget._onKeyPress)) {
      tt.__PpwConnectHandle.push(dojo.connect(formwidget, "_onKeyPress", null, dojo.hitch(this, this._hideErrorMessage,
          property)));
    }
